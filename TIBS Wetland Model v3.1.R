...
##########################################################################        
    ...
    P.GWLF.conct[which(is.na(P.GWLF.conc))] = NA
    P.GWLF.conct[which(P.GWLF.conc == 0)] = NA
    
    N.GWLF.conct[which(is.na(N.GWLF.conc))] = NA
    N.GWLF.conct[which(P.GWLF.conc == 0)] = NA
    ...
    graphics.off()
    ###############################################################
    # Create 1:1 plots of wetland model data vs. GWLF model Data #
